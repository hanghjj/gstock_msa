package com.gstock.kis.exceptions;

import com.gstock.gutils.exception.CustomException;
import com.gstock.kis.client.CoreClient;
...
import static com.gstock.kis.KisConstants.DEFAULT_ERR_MSG;

@RestControllerAdvice
@AllArgsConstructor
public class KisExceptionHandler {
